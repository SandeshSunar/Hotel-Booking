                    ...
                    <div class="col-md-6 col-lg-4">
                        <article class="rooms-card h-100">
                            <div class="rooms-image-wrap">
                                <img src="{{ asset('storage/' . $rooms->image) }}" class="rooms-image d-block mx-auto"
                                    alt="{{ $rooms->type }}">
                            </div>
                            <div class="rooms-card-body text-center">
                                <h3 class="rooms-card-title">{{ \Illuminate\Support\Str::headline($rooms->type) }}</h3>
