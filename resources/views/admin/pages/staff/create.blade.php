    ...
    <div class="p-4">
        ...
        <form action="{{ route('admin.staff.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="phone" class="form-control" value="{{ old('phone', $phone->phone ?? '') }}"
                    required>
            ...
            <div class="mb-3">
                ...
                <input type="email" name="email" class="form-control" value="{{ old('email', $email->email ?? '') }}"
                    required>
            </div>

            <div class="mb-3">
                <label>Role <span class=text-danger>*</span></label>
                <input type="text" name="role" class="form-control" value="{{ old('role', $role->role ?? '') }}"
                    required>
            </div>
